...
router.register(r"course-section", CourseSectionViewset, basename="class-details")
router.register(
    r"employee-position", EmployeePositionView, basename="employee-position"
)
router.register(r"employment-type", EmploymentTypeView, basename="employment-type")
